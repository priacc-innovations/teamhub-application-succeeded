...
export default function LeaveRequestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // No date formatting needed. HTML date input gives yyyy-mm-dd format.
    const payload = {
  ...
  const getStatusBadge = (status: string) => {
    const badges = {
      pending: { icon: Clock, label: "Pending", color: "bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300" },
      approved: { icon: CheckCircle, label: "Approved", color: "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300" },
      rejected: { icon: XCircle, label: "Rejected", color: "bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300" },
    };
