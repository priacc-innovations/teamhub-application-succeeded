...
import { getUserWallet, getMonthAttendance } from '../../../data/mockData';
...
export default function MyWallet() {
  ...
  const [totalDeductions] = useState(5000);
  ...
  const loadWalletData = () => {
    ...
    const attendance = getMonthAttendance(user.id);
  ...
  const monthlyEarning = wallet?.current_month_earned || 0;
  const dailyRate = wallet?.daily_rate || 0;
  const monthlySalary = wallet?.monthly_salary || 0;
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-white/90">
                <strong>Note:</strong> Deducted amount will be credited once your performance is
                increased and you are allocated to a project. Work on improving your performance to
                recover this amount.
              </p>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                <p>
                  ...
                  provisional earning based on your attendance from the 24th of last month to the 23rd
                  of the current month.
                </p>
                <p>
                  Final salary processing and any applicable deductions or bonuses will be calculated
                  and credited on the <strong>30th of every month</strong>.
                </p>
                <p className="text-orange-700 dark:text-orange-400 font-medium">
                  Note: Absent days are not included in earnings calculation. Each absent day reduces
                  your monthly earnings by the daily rate (${dailyRate.toFixed(2)}).
                </p>
              </div>
            </div>
          </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{workingDays}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card glassmorphism>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
              <span className="text-gray-700 dark:text-gray-300">Daily Rate (Monthly ÷ 26)</span>
              <span className="font-semibold text-gray-900 dark:text-white">
                ${dailyRate.toFixed(2)}
              </span>
            </div>
