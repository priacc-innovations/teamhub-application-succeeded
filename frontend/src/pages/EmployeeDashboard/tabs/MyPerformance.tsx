...
export default function MyPerformance() {
  ...
  const dailyData = [
    { date: 'Mar 1', rating: 8.5, tasks: 5, attendance: 100 },
    { date: 'Mar 2', rating: 8.0, tasks: 4, attendance: 100 },
    { date: 'Mar 3', rating: 9.0, tasks: 6, attendance: 100 },
    { date: 'Mar 4', rating: 8.5, tasks: 5, attendance: 100 },
    { date: 'Mar 5', rating: 7.5, tasks: 3, attendance: 100 },
    { date: 'Mar 6', rating: 8.0, tasks: 4, attendance: 100 },
    { date: 'Mar 7', rating: 8.5, tasks: 5, attendance: 100 },
    { date: 'Mar 8', rating: 9.0, tasks: 6, attendance: 100 },
    { date: 'Mar 9', rating: 8.0, tasks: 4, attendance: 100 },
    { date: 'Mar 10', rating: 8.5, tasks: 5, attendance: 100 },
    { date: 'Mar 11', rating: 8.5, tasks: 5, attendance: 100 },
    { date: 'Mar 12', rating: 9.0, tasks: 6, attendance: 100 },
    { date: 'Mar 13', rating: 8.0, tasks: 4, attendance: 100 },
    { date: 'Mar 14', rating: 8.5, tasks: 5, attendance: 100 },
    { date: 'Mar 15', rating: 8.5, tasks: 5, attendance: 100 },
  ];

  const weeklyData = [
    { week: 'Week 1', rating: 8.3, tasks: 22, attendance: 95 },
    { week: 'Week 2', rating: 8.5, tasks: 25, attendance: 98 },
    { week: 'Week 3', rating: 8.7, tasks: 27, attendance: 100 },
    { week: 'Week 4', rating: 8.4, tasks: 24, attendance: 96 },
    { week: 'Week 5', rating: 8.6, tasks: 26, attendance: 98 },
    { week: 'Week 6', rating: 8.8, tasks: 28, attendance: 100 },
    { week: 'Week 7', rating: 8.5, tasks: 25, attendance: 97 },
    { week: 'Week 8', rating: 8.9, tasks: 29, attendance: 100 },
  ];

  const monthlyData = [
    { month: 'Jan', rating: 8.2, taskCompletion: 85, behavior: 88 },
    { month: 'Feb', rating: 8.5, taskCompletion: 90, behavior: 90 },
    { month: 'Mar', rating: 8.7, taskCompletion: 92, behavior: 91 },
  ];
  ...
  const avgRating = 8.5;
  const avgTaskCompletion = 89;
  const avgBehavior = 90;
