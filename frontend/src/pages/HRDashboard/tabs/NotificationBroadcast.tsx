...
export default function NotificationBroadcast() {
  ...
  const [notifications] = useState<Notification[]>([
    {
      ...
      message: 'All employees must complete their Q1 self-assessment by March 15th.',
    ...
    },
    {
      ...
      message: 'The HRMS system will be under maintenance on March 10th from 2 AM to 4 AM.',
      target_role: 'all',
    ...
    },
    {
      ...
      message: 'Updated salary structure will be effective from April 1st, 2025.',
      target_role: 'employee',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Broadcasting notification:', formData);
    setSuccess(true);
    setTimeout(() => {
      setSuccess(false);
      setFormData({
                ...
                {success && (
                  ...
                  >
                    ...
                    <p className="text-sm font-medium text-green-800 dark:text-green-400">
                      Notification sent successfully! All targeted users have been notified.
                    </p>
                  </motion.div>
                )}
